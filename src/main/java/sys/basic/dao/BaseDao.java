...
import sys.basic.model.SystemRequest;
import sys.basic.model.SystemRequestHolder;
...
public class BaseDao<T> implements IBaseDao<T> {
    ...
    public <T extends Object> List<T> listObj(String hql, Map<String, Object> alias, Object... args) {
        hql = initSort(hql);
...
//	}
    ...
    public <T extends Object> Pager<T> findObj(String hql, Map<String, Object> alias, Object... args) {
        hql = initSort(hql);
        String cq = getCountHql(hql, true);
        Query cquery = getSession().createQuery(cq);
        Query query = getSession().createQuery(hql);
    ...
    public <T extends Object> Pager<T> findBySql(String sql,
                                                 Map<String, Object> alias, Class<?> clz, boolean hasEntity, Object... args) {
        sql = initSort(sql);
    ...
    public <T extends Object> List<T> listBySql(String sql, Class<?> clz, boolean hasEntity, Object... args) {
        return this.listBySql(sql, null, clz, hasEntity, args);
    }

    public <T extends Object> Pager<T> findBySql(String sql, Class<?> clz, boolean hasEntity, Object... args) {
    ...
    public <T extends Object> Pager<T> findObj(String hql, Object... args) {
    ...
    public <T extends Object> List<T> listObj(String hql, Object... args) {
     ...
     * @see org.konghao.baisc.dao.IBaseDao#find(java.lang.String, java.util.Map)
     */
    public <T extends Object> Pager<T> findObjByAlias(String hql, Map<String, Object> alias) {
        return this.findObj(hql, null, alias);
    }


    public <T extends Object> List<T> listByAliasSql(String sql, Map<String, Object> alias,
     ...
     */
    public <T extends Object> Pager<T> findByAliasSql(String sql, Map<String, Object> alias,
                                                      Class<?> clz, boolean hasEntity) {
